export enum MenuEvent {
  ...
  CREATE_NEXT_MOVE_COLLECTION = "createNextMoveCollection",
  STOP_NEXT_MOVE_GENERATION = "stopNextMoveGeneration",
  OPEN_NEXT_MOVE_COLLECTION = "openNextMoveCollection",
  ...
  DISPLAY_GAME_RESULTS = "displayGameResults",
