export enum Background {
  ...
  SHOW_OPEN_NEXT_MOVE_COLLECTION_DIALOG = "showOpenNextMoveCollectionDialog",
  SHOW_SAVE_NEXT_MOVE_COLLECTION_DIALOG = "showSaveNextMoveCollectionDialog",
  LOAD_NEXT_MOVE_COLLECTION = "loadNextMoveCollection",
  SAVE_NEXT_MOVE_COLLECTION = "saveNextMoveCollection",
  LOAD_NEXT_MOVE_GENERATION_SETTINGS = "loadNextMoveGenerationSettings",
  SAVE_NEXT_MOVE_GENERATION_SETTINGS = "saveNextMoveGenerationSettings",
  ...
  LOAD_BATCH_ANALYSIS_SETTINGS = "loadBatchAnalysisSettings",
  SAVE_BATCH_ANALYSIS_SETTINGS = "saveBatchAnalysisSettings",
  LIST_RECORD_FILES = "listRecordFiles",
  ...
  SEARCH_BOOK_ENTRY = "searchBookEntry",
  UPDATE_BOOK_MOVE = "updateBookMove",
  UPDATE_BOOK_POSITION_COMMENT = "updateBookPositionComment",
  ...
  FETCH_ENGINE_INDEX = "fetchEngineIndex",
  LIST_INSTALLED_ENGINE_PACKAGES = "listInstalledEnginePackages",
  FETCH_ENGINE_PACKAGE_LICENSES = "fetchEnginePackageLicenses",
  INSTALL_ENGINE_PACKAGE = "installEnginePackage",
  CANCEL_ENGINE_PACKAGE_INSTALL = "cancelEnginePackageInstall",
  UNINSTALL_ENGINE_PACKAGE = "uninstallEnginePackage",
...
export enum Renderer {
  ...
  OPEN_RECORD = "openRecord",
  ENGINE_PACKAGE_INSTALL_PROGRESS = "enginePackageInstallProgress",
