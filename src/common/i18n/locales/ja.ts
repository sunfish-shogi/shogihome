...
export const ja: Texts = {
  ...
  downloadEngines: "ダウンロード",
  downloadAnEngine: "エンジンをダウンロード",
  engineDownload: "エンジンのダウンロード",
  availableEngines: "入手可能",
  installedEngines: "インストール済み",
  install: "インストール",
  reinstall: "再インストール",
  uninstall: "アンインストール",
  ...
  agreeAndDownload: "同意してダウンロード",
  sourceCodeURL: "ソースコード",
  noDownloadableEngine: "ダウンロードできるエンジンがありません。",
  noInstalledEngine: "インストール済みのエンジンはありません。",
  engineDistributedByThirdParty: (publisher) =>
    `このエンジンは ${publisher} が配布しています。ShogiHome の一部ではありません。`,
  copyleftLicenseNotice:
    "このエンジンにはコピーレフトのライセンスが含まれています。再配布する場合はライセンスの条件に従ってください。",
  enginesAddedPleaseSave:
    "エンジン一覧に追加しました。エンジン管理画面で「保存して閉じる」を押すと確定します。",
  enginesUpdatedPleaseSave:
    "エンジンを更新しました。エンジン管理画面で「保存して閉じる」を押すと確定します。",
  areYouSureWantToUninstallEngine: (name) => `${name} のダウンロードしたファイルを削除しますか？`,
  failedToFetchEngineList: "エンジンの一覧を取得できませんでした",
  downloadedFileIsCorrupted: "ダウンロードしたファイルが壊れています",
  engineIsInUse: "エンジンが使用中です。対局や検討を終了してからやり直してください。",
