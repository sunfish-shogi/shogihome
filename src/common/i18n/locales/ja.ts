...
export const ja: Texts = {
  ...
  noProblemsWereGeneratedAndFileWasNotCreated:
    "採用できる局面がなかったため、問題集ファイルは作成されませんでした。",
  doYouWantToSaveNProblems: (n: number) => `作成済みの${n}問を保存しますか？`,
  doYouWantToStartQuiz: "出題を開始しますか？",
  doYouWantToResumeFromWhereYouLeftOff: "前回の続きから再開しますか？",
  nextMoveGenerationRequiresAnalyzedRecord:
    "問題集作成機能では解析コメントで悪手の候補を抽出してから、エンジンを起動して複数の候補手を求めます。事前に解析機能を実行して解析コメント付きの棋譜を用意してください。",
  files: "ファイル数",
  blunderCandidates: "悪手候補",
  adoptedProblems: "採用した問題",
  researchedPositions: "再探索済みの局面",
  recordDirectory: "棋譜ディレクトリ",
  winRateDropThreshold: "勝率降下幅",
  minWinRate: "対象局面評価の下限",
  adoptionWinRateDiff: "採用判定の勝率差",
  acceptableWinRateDiff: "正解範囲の勝率差",
  maxProblems: "問題数の上限",
  outputFile: "出力ファイル",
  ...
  correctRate: "正解率",
  actualGameMove: "実戦の手",
  thisMoveWasPlayedInTheGame: "実戦で指された手です。",
  doYouWantToTryAgain: "もう一度チャレンジしますか？",
  showAnswer: "答えを見る",
  nextProblem: "次の問題",
  ...
  copyAnalysisForLLM: "LLM解説用にコピー",
  analysisCopyPrompt: "LLM解説用プロンプト",
  defaultAnalysisCopyPrompt:
    "以下のBOD局面と、エンジンが出力した候補手・評価値・読み筋をもとに、日本語で解説してください。\n\n【解析結果の扱い】\n・提示された局面と解析結果を解説の根拠とし、独自の変化や読み筋を作らないでください。\n・評価値は、併記された視点・符号・詰み・上下限の説明に従って解釈してください。\n・「駒取り」「王手」「当たり」と説明するときは、その手順まで進めた盤面で、駒の位置・利き・途中の遮りを確認してください。確認できない場合は断定しないでください。\n・解析結果から直接分かることと、狙いについての推測を区別してください。\n\n【ユーザーについて】\n・棋力は将棋ウォーズ2級です。\n・振り飛車党で、特に四間飛車を好みます。ただし、解説は提示された局面に即して行ってください。\n\n【解説の方針】\n・局面の特徴を簡潔に説明し、主な候補手の狙いと違い、提示された読み筋にある注意すべき応手を説明してください。\n・長い変化の羅列よりも、「なぜその手が良いか」「次回、似た局面でどう気づくか」を重視してください。\n・最後に「今回覚えるポイント」を原則1つに絞って示してください。",
  noAnalysisToCopy:
    "現在の局面に対応する読み筋がありません。検討を開始し、読み筋が表示されてからコピーしてください。",
  analysisCopyScoreNote:
    "評価値はこの局面の手番側から見た値です。cp はエンジンの評価値（正は有利、負は不利）、mate は詰み手数（正は詰ませる側、負は詰まされる側、0 は詰まされた状態）です。mate の + / - は手数未確定を示します。>= / <= は評価値の下限 / 上限です。候補ごとの探索深さは異なる場合があります。",
  analysisCopyTruncatedPV: "解釈できない指し手以降を省略",
  recordAnalysis: "棋譜解析",
  analysis: "解析",
  analyze: "解析開始",
  stopAnalysis: "解析中断",
  ...
  handPieceOrder: "持ち駒の並び順",
  rookGoldKnightToLeft: "飛・金・桂を左に",
  rookGoldKnightToRight: "飛・金・桂を右に",
  ...
  settingsFileCorruptedMovedAndReset(path: string, backupPath: string): string {
    return `設定ファイル ${path} が破損していたため読み込めませんでした。壊れたファイルは ${backupPath} に移動し、既定の設定を使用します。`;
  },
};
