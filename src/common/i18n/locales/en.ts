...
export const en: Texts = {
  ...
  noProblemsWereGeneratedAndFileWasNotCreated:
    "No positions were adopted, so the collection file was not created.",
  doYouWantToSaveNProblems: (n: number) => `Do you want to save ${n} problems?`,
  doYouWantToStartQuiz: "Do you want to start the quiz?",
  doYouWantToResumeFromWhereYouLeftOff: "Do you want to resume from where you left off?",
  nextMoveGenerationRequiresAnalyzedRecord:
    "This feature extracts blunder candidates from analysis comments, then launches an engine to find multiple candidate moves. Please run the analysis feature beforehand to prepare record files with analysis comments.",
  files: "Files",
  blunderCandidates: "Blunder Candidates",
  adoptedProblems: "Adopted Problems",
  researchedPositions: "Researched Positions",
  recordDirectory: "Record Directory",
  winRateDropThreshold: "Win Rate Drop",
  minWinRate: "Minimum Position Eval",
  adoptionWinRateDiff: "Adoption Judgment Win Rate Diff",
  acceptableWinRateDiff: "Correct Answer Range Win Rate Diff",
  maxProblems: "Max Problems",
  ...
  actualGameMove: "Actual Game Move",
  thisMoveWasPlayedInTheGame: "This move was played in the actual game.",
  ...
  handPieceOrder: "Hand Piece Order",
  rookGoldKnightToLeft: "Rook, Gold, and Knight on the Left",
  rookGoldKnightToRight: "Rook, Gold, and Knight on the Right",
  ...
  downloadEngines: "Download",
  downloadAnEngine: "Download an Engine",
  engineDownload: "Download Engines",
  ...
  noDownloadableEngine: "No engines available for download.",
  noInstalledEngine: "No engines installed.",
  engineDistributedByThirdParty: (publisher) =>
    `This engine is distributed by ${publisher}. It is not part of ShogiHome.`,
  copyleftLicenseNotice:
    "This engine includes copyleft licenses. If you redistribute it, you must follow the terms of the licenses.",
  enginesAddedPleaseSave:
    'Added to the engine list. Press "Save and Close" in Engine Management to apply.',
  enginesUpdatedPleaseSave:
    'The engine has been updated. Press "Save and Close" in Engine Management to apply.',
  areYouSureWantToUninstallEngine: (name) => `Delete the downloaded files of ${name}?`,
  failedToFetchEngineList: "Failed to fetch the engine list",
  downloadedFileIsCorrupted: "The downloaded file is corrupted",
  engineIsInUse: "The engine is in use. Please stop the game or research and try again.",
  ...
  failedToLoadEngine: "Failed to load the engine.",
  engineRequiresOnline: "Loading the engine requires an internet connection.",
  engineRequiresReload: "Reload the page to use the engine.",
