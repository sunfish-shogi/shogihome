...
export const en: Texts = {
  ...
  header: "Header",
  plyAndLastMove: "Ply and Last Move",
  bookmarkOrCustomText: "Bookmark or Custom Text",
  lastMoveOnly: "Last Move Only",
  bookmarkOrCustomTextAndLastMove: "Bookmark or Custom Text and Last Move",
  withBrackets: (format) => `${format} (with 【】)`,
  vertical: "Vertical",
  size: "Size",
  none: "None",
  bgCover: "Cover",
