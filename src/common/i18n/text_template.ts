export type Texts = {
  ...
  noProblemsWereGeneratedAndFileWasNotCreated: string;
  doYouWantToSaveNProblems(n: number): string;
  doYouWantToStartQuiz: string;
  doYouWantToResumeFromWhereYouLeftOff: string;
  nextMoveGenerationRequiresAnalyzedRecord: string;
  files: string;
  blunderCandidates: string;
  adoptedProblems: string;
  researchedPositions: string;
  recordDirectory: string;
  winRateDropThreshold: string;
  minWinRate: string;
  adoptionWinRateDiff: string;
  acceptableWinRateDiff: string;
  maxProblems: string;
  outputFile: string;
  ...
  incorrect: string;
  correctRate: string;
  actualGameMove: string;
  thisMoveWasPlayedInTheGame: string;
  doYouWantToTryAgain: string;
  showAnswer: string;
  nextProblem: string;
  ...
  skipAnalyzed: string;
  analyzedRecordFilesWillBeOverwritten: string;
  ...
  add: string;
  addFromFile: string;
  downloadEngines: string;
  downloadAnEngine: string;
  ...
  publisher: string;
  downloadSize: string;
  agreeAndDownload: string;
  sourceCodeURL: string;
  noDownloadableEngine: string;
  noInstalledEngine: string;
  engineDistributedByThirdParty: (publisher: string) => string;
  copyleftLicenseNotice: string;
  enginesAddedPleaseSave: string;
  enginesUpdatedPleaseSave: string;
  areYouSureWantToUninstallEngine: (name: string) => string;
  failedToFetchEngineList: string;
  downloadedFileIsCorrupted: string;
  engineIsInUse: string;
